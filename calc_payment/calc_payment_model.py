...
class CalcPayment:
    ...
    def calc_monthly_payment(self) -> float:
        if self.amount == 0:
            ...
            raise calc_payment_exceptions.NegativeNumberOfPayments
    ...
    def calc_extra_payment(self, extra_payment: float, payment_number: int) -> list:
        balance: float = 0
